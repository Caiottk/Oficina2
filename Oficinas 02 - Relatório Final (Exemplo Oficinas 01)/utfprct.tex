%% UTFPRCT-TEX, v1.0.6 wmeira on 2024/06/15
...
%%
\Licenca{Nenhuma} %Default: \Licenca{CC-BY}
...
\include{2.O_Jogo/O_Jogo}
\include{3.Mecânica/Mecanica}
\include{3.Hardware/Hardware}
\include{4.Software/Software}
\include{5.Resultados/Resultados}
\include{6.Conclusao/Conclusao}
